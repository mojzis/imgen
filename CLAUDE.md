...
Small shared library for generating images through Replicate. Package: `src/imgen/`, distributed as tagged GitHub releases (not on PyPI).
...
- Releases are git tags only (`poe release`); consumers install from GitHub, see README.
